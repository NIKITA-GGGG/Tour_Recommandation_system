	...
	return (
		...
		>
			...
			<div className="fixed top-6 right-8 z-30 flex gap-4">
				<Link
					to="/login"
					className="px-6 py-2 bg-white/90 text-blue-700 font-semibold rounded-xl shadow hover:bg-blue-50 border border-blue-200 transition-colors text-base"
				>
					Login
				</Link>
				<Link
					to="/register"
					className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl shadow hover:from-blue-700 hover:to-purple-700 border border-blue-200 transition-colors text-base"
				>
					Register
				</Link>
			</div>
			...
			<div className="relative z-20 flex flex-col items-center justify-center text-center px-6 py-20 w-full">
				...
				<div className="flex flex-col items-center mb-8">
					...
					<h1
						className="text-5xl md:text-6xl font-extrabold text-white drop-shadow mb-2 tracking-tight"
					...
					<p className="text-xl md:text-2xl text-blue-100 font-medium max-w-2xl mt-4 mb-6">
						Your smart travel companion for personalized, effortless, and optimized trip
						planning.
					</p>
				</div>
				...
				<div
					className="bg-white/90 rounded-3xl shadow-2xl p-8 max-w-2xl mx-auto mb-12 border border-blue-200"
					style={{ backdropFilter: "blur(2px)" }}
				>
					<h2 className="text-2xl md:text-3xl font-bold text-indigo-700 mb-4 tracking-tight">
						What is TourRec?
					</h2>
					<p className="text-lg text-gray-700 leading-relaxed">
						<span className="font-semibold text-blue-700">TourRec</span> is a modern
						tour recommendation and planning system. It helps you discover the best
						places to visit, plan and optimize your route, and save your favorite
						tours—all tailored to your preferences and location. Say goodbye to travel
						stress and hello to seamless, personalized adventures.
					</p>
				</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="bg-white/90 rounded-2xl shadow-lg p-6 flex flex-col items-center border border-blue-100">
							...
							<p className="text-gray-700 text-sm">
								Get place suggestions based on your interests, preferences, and
								location.
							</p>
						</div>
						<div className="bg-white/90 rounded-2xl shadow-lg p-6 flex flex-col items-center border border-blue-100">
							...
							<p className="text-gray-700 text-sm">
								Plan the most efficient route for your trip, saving time and
						...
						<div className="bg-white/90 rounded-2xl shadow-lg p-6 flex flex-col items-center border border-blue-100">
							...
							<p className="text-gray-700 text-sm">
								Save your planned tours, view details, and manage your travel
								history easily.
							</p>
						</div>
						<div className="bg-white/90 rounded-2xl shadow-lg p-6 flex flex-col items-center border border-blue-100">
							...
							<p className="text-gray-700 text-sm">
								Browse and discover top destinations, attractions, and hidden gems
								across regions.
							</p>
						</div>
						<div className="bg-white/90 rounded-2xl shadow-lg p-6 flex flex-col items-center border border-blue-100">
							...
							<p className="text-gray-700 text-sm">
								Set your travel preferences and manage your profile for a tailored
								experience.
							</p>
						</div>
						<div className="bg-white/90 rounded-2xl shadow-lg p-6 flex flex-col items-center border border-blue-100">
				...
				<div className="w-full max-w-4xl mx-auto mb-12">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="bg-white/90 rounded-2xl shadow-lg p-6 flex flex-col items-center border border-blue-100">
							...
							<p className="text-gray-700 text-sm">
								Sign up, set your travel interests, and let TourRec know what you
								love.
							</p>
						</div>
						<div className="bg-white/90 rounded-2xl shadow-lg p-6 flex flex-col items-center border border-blue-100">
							...
							<p className="text-gray-700 text-sm">
								Receive personalized place suggestions and optimized trip plans
								instantly.
							</p>
						</div>
						<div className="bg-white/90 rounded-2xl shadow-lg p-6 flex flex-col items-center border border-blue-100">
							...
							<p className="text-gray-700 text-sm">
								Save your tour, view your dashboard, and enjoy a seamless travel
								experience.
							</p>
						</div>
					</div>
